import { getCurrentInstance, reactive, inject, ref, onMounted } from 'vue';
...
function usePrintBridge() {
  const instance = getCurrentInstance();
  const bridgeClient = inject("vuePrintItBridge") || (instance == null ? void 0 : instance.appContext.config.globalProperties.$printBridge);
  const bridgeOptions = inject("vuePrintItBridgeOptions");
  const bridgeState = inject("vuePrintItBridgeState") || (instance == null ? void 0 : instance.appContext.config.globalProperties.$printBridgeState);
...
export { BridgeClient, createVuePrintIt, createVuePrintItBridge, createVuePrintIt as default, usePrint, usePrintBridge };
